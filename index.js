 ...
 * Homepage: https://shopilo.it/negozi/1000farmacie.it
 */

const SHOPILO_URL = "https://shopilo.it/negozi/1000farmacie.it";
const STORE_NAME  = "1000Farmacie";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-it/codice-sconto-1000farmacie)" }
  });
