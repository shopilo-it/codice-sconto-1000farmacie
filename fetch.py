#!/usr/bin/env python3
"""
Recupero codici sconto 1000Farmacie da shopilo.it
Sursa: https://shopilo.it/negozi/1000farmacie.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/1000farmacie.it"
STORE_NAME = "1000Farmacie"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per 1000Farmacie da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-1000farmacie)"
    }
    try:
